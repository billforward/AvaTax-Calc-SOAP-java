...
public class AddressSvcSoapStub extends com.avalara.avatax.services.base.BaseSvcSoapStub implements com.avalara.avatax.services.address.AddressSvcSoap {
    ...
    public AddressSvcSoapStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        cachedSerQNames.add(qName);
        cls = com.avalara.avatax.services.address.BaseAddress.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
        ...
        cachedSerQNames.add(qName);
        cls = com.avalara.avatax.services.address.BaseRequest.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
        ...
        qName = new javax.xml.namespace.QName("http://avatax.avalara.com/services", "RequestList");
        cachedSerQNames.add(qName);
        cls = com.avalara.avatax.services.address.RequestList.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);

        qName = new javax.xml.namespace.QName("http://avatax.avalara.com/services", "ResultList");
        cachedSerQNames.add(qName);
        cls = com.avalara.avatax.services.address.ResultList.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
    ...
    public com.avalara.avatax.services.address.ValidateResult validate(com.avalara.avatax.services.address.ValidateRequest validateRequest) throws java.rmi.RemoteException
    {
        ...
        try
        {
            ...
            timer.start();           
            java.lang.Object _resp=invokeService(_call,new java.lang.Object[] {validateRequest});            
    ...
    public com.avalara.avatax.services.address.IsAuthorizedResult isAuthorized(java.lang.String operations) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
        try {        java.lang.Object _resp=invokeService(_call,new java.lang.Object[] {operations});
