        ...
        if(started)
        {
            ...
            if(result.getClass().getName().equals("com.avalara.avatax.services.tax.GetTaxResult"))
            {
                ...
                try
                {
                    ...
                    {
                        taxSvc.ping(MetricUtility.BuildAuditMetrics("",taxResult.getTransactionId().toString(),totalTimeTaken));
                    }
                }
                catch (Exception e)
                {
            ...
            else if(result.getClass().getName().equals("com.avalara.avatax.services.address.ValidateResult"))
            {
                ...
                try
                {
                    addressSvc.ping(MetricUtility.BuildAuditMetrics("",addressResult.getTransactionId().toString(),totalTimeTaken));
                }
                catch (Exception e)
                {
                    //Ignore Exception while sending ClientMetrics
